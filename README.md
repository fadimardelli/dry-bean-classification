...
Dataset used for this study is [Dry Bean](https://archive.ics.uci.edu/dataset/602/dry+bean+dataset). [[1]](#ref-1)
...
The data is stored in arff, txt and xlsx format in [data](/data/) folder. [[1]](#ref-1)
